...
def convert_txt_to_json(input_folder, output_folder):
    ...
    for filename in os.listdir(input_folder):
        ...
        if filename.endswith(".txt"):
            ...
            output_file = os.path.join(output_folder, filename.replace(".txt", "_CommandGUIButton.json"))
            ...
            # 构建JSON结构
            json_data = {
                "displayName": filename.replace(".txt", ""),  # 使用文件名作为displayName
                "raw": processed_commands
            }
